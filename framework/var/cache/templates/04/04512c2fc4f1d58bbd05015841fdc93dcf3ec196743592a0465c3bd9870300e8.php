        ...
        foreach ($context['_seq'] as $context["_key"] => $context["singleQuestion"]) {
            ...
            echo "
                <tr>
                    <th scope=\"row\"> ";
            // line 60
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["singleQuestion"], "id_question", [], "any", false, false, false, 60), "html", null, true);
            echo "</th> </th>
                    <td>";
            // line 61
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["singleQuestion"], "label", [], "any", false, false, false, 61), "html", null, true);
            echo "</td>
                    <td>";
            // line 62
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["singleQuestion"], "level", [], "any", false, false, false, 62), "html", null, true);
            echo "</td>
                    <td>";
            // line 63
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["singleQuestion"], "question", [], "any", false, false, false, 63), "html", null, true);
            echo "</td>
            ...
            // line 65
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["singleQuestion"], "id_question", [], "any", false, false, false, 65), "html", null, true);
        ...
        <div class=\"modal-content\">
            ...
            <form action=\"questions\" method=\"post\">
                <div class=\"modal-body list-group list-group-flush\">
                    ...
                    <div class=\"list-group-item\">
                        <label for=\"exampleInputEmail1\" class=\"form-label\">Label question</label>
                        <input class=\"form-control labelUpdate\" type=\"text\" name=\"labelUpdate\">
                    </div>
                    <div class=\"list-group-item\">
                        <label for=\"exampleInputEmail1\" class=\"form-label\">Niveau de difficulté</label>
                        <select id=\"level\" class=\"form-select\" name=\"levelUpdate\">
                            <option value=\"Vert\">Vert</option>
                            <option value=\"Jaune\">Jaune</option>
                            <option value=\"Bleu\">Bleu</option>
                            <option value=\"Orange\">Orange</option>
                    ...
                    <div class=\"list-group-item\">
                        <label for=\"exampleInputEmail1\" class=\"form-label\">Question</label>
                        <input class=\"form-control questionUpdate\" type=\"text\" name=\"questionUpdate\">
                    </div>
                ...
                <div class=\"modal-footer\">
                    ...
                    <button type=\"submit\" class=\"btn btn-danger\"  name=\"deleteQuestions\">Supprimer</button>
...
";
    ...
    {
        return array (  298 => 26,  294 => 25,  180 => 71,  168 => 65,  163 => 63,  159 => 62,  155 => 61,  151 => 60,  147 => 58,  143 => 57,  112 => 28,  109 => 25,  105 => 24,  95 => 22,  86 => 16,  82 => 15,  76 => 12,  72 => 11,  66 => 8,  62 => 7,  56 => 4,  52 => 3,  41 => 1,);
    }

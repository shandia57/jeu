...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["answer"]) {
            // line 39
            echo "                    ";
            if ((twig_get_attribute($this->env, $this->source, $context["answer"], "valid", [], "any", false, false, false, 39) == "1")) {
                // line 40
                echo "                    <li class=\"list-group-item\" style=\"color:green;\" data-id=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["answer"], "id_answer", [], "any", false, false, false, 40), "html", null, true);
                echo "\" data-value=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["answer"], "valid", [], "any", false, false, false, 40), "html", null, true);
                echo "\" data-bs-toggle=\"modal\" data-bs-target=\"#updateAnswerModal\" onclick=\"updateAnswer(this)\">";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["answer"], "answer", [], "any", false, false, false, 40), "html", null, true);
                echo "</li>
                    ";
            } else {
                // line 42
                echo "                    <li class=\"list-group-item\"  data-id=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["answer"], "id_answer", [], "any", false, false, false, 42), "html", null, true);
                echo "\" data-value=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["answer"], "valid", [], "any", false, false, false, 42), "html", null, true);
                echo "\" data-bs-toggle=\"modal\" data-bs-target=\"#updateAnswerModal\" onclick=\"updateAnswer(this)\">";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["answer"], "answer", [], "any", false, false, false, 42), "html", null, true);
                echo "</li>
                    ";
            }
            // line 44
    ...
    <div class=\"modal fade\" id=\"addAnswerModal\" tabindex=\"-1\" aria-hidden=\"true\">
        ...
        echo "</div>
                        ...
                        <div class=\"modal-footer\">
                                <button type=\"button\" class=\"btn btn-secondary\" data-bs-dismiss=\"modal\">Close</button>
                                <button type=\"submit\" id=\"btnDelete\" class=\"btn btn-outline-danger\" name=\"deleteAnswer\">Supprimer</button>
...
";
    ...
    {
        return array (  248 => 25,  244 => 24,  222 => 94,  189 => 64,  168 => 45,  162 => 44,  152 => 42,  142 => 40,  139 => 39,  135 => 38,  132 => 37,  124 => 35,  119 => 32,  115 => 31,  109 => 27,  106 => 24,  102 => 23,  94 => 21,  86 => 16,  82 => 15,  76 => 12,  72 => 11,  66 => 8,  62 => 7,  56 => 4,  52 => 3,  41 => 1,);
    }
